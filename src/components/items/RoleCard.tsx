...
/**
 * Tarot-style role card. Displays the role's icon, name, team, description,
 * and win condition inside a themed card frame with a subtle 3D float animation.
 *
...
export function RoleCard({ roleId }: Props) {
    ...
    return (
        <div
            className={cn(
                "animate-card-float relative w-full max-w-sm mx-auto rounded-xl border-2 shadow-tarot overflow-hidden",
                team.colors.cardBg,
        ...
        >
            ...
            <div className="relative z-10 px-8 py-10 parchment-texture">
                ...
                <MysticDivider
                    ...
                    iconClassName={
                        isEvil ? "text-red-500/50" : "text-mystic-gold/50"
                    }
                />
