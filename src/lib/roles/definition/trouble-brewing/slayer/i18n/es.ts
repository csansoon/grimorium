const es = {
  ...
  lines: [
    {
      type: 'DAY',
      text: 'Durante el día, puedes disparar públicamente a un jugador.',
    },
    {
      type: 'INFO',
      text: 'Si es el Demonio, muere instantáneamente. Si no, no pasa nada.',
    },
  ...
  // History
  history: {
    targetDied: '¡{slayer} disparó a {target} — el objetivo murió!',
