const es = {
  ...
  lines: [
    ...
    {
      type: 'CAVEAT',
      text: 'En lugar de esta carta, ves la carta de otro rol.',
    },
    {
      type: 'CAVEAT',
      text: 'La habilidad que crees tener no funciona. El Cuentacuentos puede darte información verdadera o falsa.',
    },
